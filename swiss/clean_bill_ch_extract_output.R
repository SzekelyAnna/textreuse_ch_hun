...
clean_bill_ch_extract_output <- function(txt){

  txt_full <- pdf_text(txt)
  #txt_full <- pdf_text("C:/_swisshun/swiss/output bills/19900257-1.pdf")
  
  start <- pages_output$page_start[i]
  end <- pages_output$page_end[i]
...
#str_detect(txt_clean[1],"\u00EA") #ê
#str_detect(txt_clean[1],"\u00E9") #é
#str_detect(txt_clean[2],"\u00FB") #u
#str_detect(txt_clean[1],":")
...
#DISCUSS
sessionInfo()
iconv("ao\u00FBt","latin1", "UTF-8")

#remove page number from pdf
txt_clean <- gsub("\\d{1,4}\\\n$", "\n", txt_clean)

#OUTPUT
txt_clean <- gsub("\\\n(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)
txt_clean <- gsub("\\\n (Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)

txt_clean <- gsub("\\\n(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)
txt_clean <- gsub("\\\n(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)
txt_clean <- gsub("\\\n(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)

txt_clean <- gsub("\\\n (Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)
txt_clean <- gsub("\\\n (Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)
txt_clean <- gsub("\\\n (Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)

txt_clean <- gsub("\\\n\\s*(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)
txt_clean <- gsub("\\\n\\s*(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)
txt_clean <- gsub("\\\n\\s*(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}\\s+(Conseil des Etats|Conseil national)\\,\\s(1er)\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*?$", "\\\n", txt_clean)

txt_clean <- gsub("\\\n(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*", "\\\n", txt_clean)
txt_clean <- gsub("\\(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*", "\\\n", txt_clean)
txt_clean <- gsub("\\\n\\s*(Conseil des Etats|Conseil national)\\,\\s\\d{1,2}\\s(janvier|f\u00E9vrier|mars|avril|mai|juin|juillet|ao\u00FBt|septembre|octobre|novembre|d\u00E9cembre)\\s\\d{4}.*", "\\\n", txt_clean)
